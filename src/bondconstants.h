...
typedef enum RUNTIMEBITFLAG {
    ...
    RUNTIMEBITFLAG_00000004 = 1 << 2,
    RUNTIMEBITFLAG_00000008 = 1 << 3,
    RUNTIMEBITFLAG_00000010 = 1 << 4,
    RUNTIMEBITFLAG_00000020 = 1 << 5,
    RUNTIMEBITFLAG_00000040 = 1 << 6,
    RUNTIMEBITFLAG_00000080 = 1 << 7,
    RUNTIMEBITFLAG_00000100 = 1 << 8,
    RUNTIMEBITFLAG_00000200 = 1 << 9,
    RUNTIMEBITFLAG_00000400 = 1 << 10,
    RUNTIMEBITFLAG_00000800 = 1 << 11,
    RUNTIMEBITFLAG_00001000 = 1 << 12,
    RUNTIMEBITFLAG_00002000 = 1 << 13,
    RUNTIMEBITFLAG_00004000 = 1 << 14,
    RUNTIMEBITFLAG_00008000 = 1 << 15,
    RUNTIMEBITFLAG_00010000 = 1 << 16,
    RUNTIMEBITFLAG_00020000 = 1 << 17,
    RUNTIMEBITFLAG_00040000 = 1 << 18,
    RUNTIMEBITFLAG_00080000 = 1 << 19,
