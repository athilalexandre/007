...
#define BG_SEG_TO_PTR(base, off) (((u32)(off) == 0) ? NULL : ((void *) (((u8 *) (base)) + (((u32)(__builtin_bswap32((u32)(off))) > 0x00FFFFFF) ? (__builtin_bswap32((u32)(off)) & 0x00FFFFFF) : ((u32)(off) & 0x00FFFFFF)))))
